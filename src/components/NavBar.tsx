...
const CTAs = () => {
	return (
		<div className='flex items-center gap-3'>
			...
			<button className='border-2 border-secondary bg-secondary px-4 py-2 font-semibold  transition-colors hover:border-white hover:bg-transparent text-white'>
				<span>Show Room</span>
			</button>
		</div>
	)
			...
			<div className='col-span-12 flex flex-col justify-between bg-neutral-950 p-6 lg:col-span-4'>
				<div>
					...
					<p className='mb-6 max-w-xs text-sm text-neutral-400'>
						Placeholder is the leading placeholder company.
					</p>
				</div>
				<a
					href='#'
			...
			<AnimatePresence>
				{open && (
					...
					>
						...
						<div className='flex justify-end bg-secondary p-6'>
							<CTAs />
						</div>
					</motion.nav>
				)}
